...
public class DB_Controller2 extends SQLiteOpenHelper {
    ...
    private static final String TABLE_COLLECTION = "decks";
    private static final String COLUMN_COLLECTION_ACCOUNT = "deck";
    ...
    public DB_Controller2(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
        super(context, "decks.db", factory, version);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        Log.e(TABLE_COLLECTION, "TABLE DECKS HAS BEEN MADE");
    }
