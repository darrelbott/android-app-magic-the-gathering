...
import com.darrelbott.finalproject.DB_Controller2;
...
class CollectionSearchViewHolder extends RecyclerView.ViewHolder {

    public TextView card_name, type, rarity, artist;
    public Button addCollectionButton;

    public CollectionSearchViewHolder(@NonNull View itemView) {
        super(itemView);
...
public class CollectionSearchAdapter extends RecyclerView.Adapter<SearchViewHolder> {

    private static final String TAG = CollectionSearchAdapter.class.getSimpleName();
    private Context mContext;
    private List<Cards> cards;
    private final DB_Controller2 dbController;
    ...
    public SearchAdapter(Context context, List<Cards> cards) {
        ...
        dbController = new DB_Controller2(context,"decks.db",null,1);
        this.cards = cards;
    }

    @NonNull
    @Override
    public CollectionSearchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View itemView = inflater.inflate(R.layout.layout_item, parent, false);
        return new CollectionSearchViewHolder(itemView);
    }

    Button addCollectionButton;

    @Override
    public void onBindViewHolder(@NonNull CollectionSearchViewHolder holder, final int position) {
        ...
        */
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // add data as needed
                dbController.insert_card("DeckName",cardName, cardType, cardRarity, cardArtist);
                Toast.makeText(mContext, "ADDED TO DECK: " + cardName, Toast.LENGTH_LONG).show(); //confirm card was added
            }
        });
        /*
